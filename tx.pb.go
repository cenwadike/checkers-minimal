...
func (*MsgCreateGame) Descriptor() ([]byte, []int) {
	return fileDescriptor_e79e2d469b5549f3, []int{0}
}
...
func (*MsgCreateGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_e79e2d469b5549f3, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "cenwadike.checkers.v1.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "cenwadike.checkers.v1.MsgCreateGameResponse")
}

func init() { proto.RegisterFile("cenwadike/checkers/v1/tx.proto", fileDescriptor_e79e2d469b5549f3) }

var fileDescriptor_e79e2d469b5549f3 = []byte{
	...
	0x92, 0xd8, 0xc0, 0x81, 0x6e, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x42, 0x56, 0x3b, 0x60, 0x1a,
	0x02, 0x00, 0x00,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cenwadike.checkers.v1.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cenwadike.checkers.v1.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cenwadike.checkers.v1.Msg",
	...
	Metadata: "cenwadike/checkers/v1/tx.proto",
}
